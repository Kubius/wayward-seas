data:extend{
    ...
    },
    {
        ...
        expression = "gleba_select(gleba_elevation+12, 0, 5, 0.5, 0, 1)"
    },
}
...
data.raw["noise-expression"]["gleba_stone_richness"].expression = "500 * max(starting, gleba_simple_spot(1000, 12 * size ^ 0.5, 220 / frequency ^ 0.5, 1) * max(gleba_highland*10, gleba_midland_aux_2, wayward_seas_lowstone)) * richness / size"
